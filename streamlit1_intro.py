...
st.dataframe(CR.tabla_violaciones.style.background_gradient(cmap="Blues"),hide_index = True)
st.dataframe(CR.tabla_violaciones.style.applymap(MCF.highlight_high_values, subset=['Porcentaje Violaciones (%)']))